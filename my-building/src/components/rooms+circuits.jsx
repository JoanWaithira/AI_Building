...
export default function CesiumGeoJsonViewer({ onFeatureClick }) {
  ...
  const zoomToFloor = (floor) => {
    const resolveFloorLevel = (requestedFloorRaw) => {
      ...
      // Common human-floor vs BldgLevel offset used in this dataset.
      ...
      // Support labels like L03 / B01 / Roof.
    ...
    if (!Number.isFinite(targetFloor)) {
      console.warn("No matching floor found for:", floor, "available floors:", availableFloorsRef.current);
      return;
    }
